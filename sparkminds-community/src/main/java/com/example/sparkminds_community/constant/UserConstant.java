package com.example.sparkminds_community.constant;
...
public class UserConstant extends CommonConstant {
    ...
    public static final String INVALID_USER_ALREADY_EXIST = "User already exists.";
    public static final String INVALID_USER_NOT_EXIST = "User does not exists";
